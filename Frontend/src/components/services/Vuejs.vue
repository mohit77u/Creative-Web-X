        ...
        <section class="service-first">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <img src="/images/vuejs.png" alt="vue">
                    </div>
                </div>
            </div>
        </section>
...
export default {
    ...
    data(){
        return{
            ...
            styleData:[
                {image:'ui.png', title:'Light weight', desc:'Vue.js is considered to be the most progressive light weight framework for building user interfaces.'},
                {image:'speed.png', title:'High performing, scalable', desc:'It allows you to work freely on any app and ensures seamless integration.'},
