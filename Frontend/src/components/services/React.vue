...
export default {
    ...
    data(){
        return{
            ...
            styleData:[
                {image:'ui.png', title:'Regular Websites', desc:'ReactJS is good for the regular corporate websites too.'},
                {image:'speed.png', title:'Support and future maintenance', desc:'Easy annual maintenance plans for you.'},
